...
public class Data {
    ...
    public static String[][] data = new String[][] {
            ...
            {"28 MINUTES OF MASHUPS!","Support us on Patreon! https://patreon.com/tspmusic | Hope everyone's doing well! We know staying home and social distancing isn't the easiest. So we've compiled some of your (and our) favourite mashups into one massive video to keep you guys entertained during these difficult times. Feel free to listen on repeat Enjoy!","7FzLVQnKx9E"}
    };
